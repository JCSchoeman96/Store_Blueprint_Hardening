defmodule Store.Entitlements.Queries.UserEntitlementIndexQuery do
  @moduledoc """
  Typed entitlement listing query for user surfaces.
  """
  ...
  defstruct status: nil, limit: 50, offset: 0

  @type t :: %__MODULE__{
          status: Store.Entitlements.Types.EntitlementStatus.t() | nil,
          limit: pos_integer(),
  ...
  def new(params) when is_map(params) do
    with :ok <- validate_keys(params),
      ...
      {:ok, %__MODULE__{status: status, limit: limit, offset: offset}}
    end
  end
