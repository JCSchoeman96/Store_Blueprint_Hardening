defmodule Store.Payments.Queries.PaymentIntentIndexQuery do
  @moduledoc """
  Normalized query contract for payment-intent list reads.
  """
  ...
  @default_offset 0
  @max_offset 10_000
  @allowed_keys MapSet.new(["limit", :limit, "offset", :offset])
  ...
  def new(params) when is_map(params) do
    with :ok <- validate_keys(params),
      ...
      {:ok, %__MODULE__{limit: limit, offset: offset}}
    end
  end
