...
`PR #8` itself did not activate SUBS. SUBS subsequently completed its independent activation gates. The current SUBS authority tip is `317d3c1e4304f671162b53f9d31a060682849e9e`, the verified PR #27 authority-reconciliation merge commit; it is not the development base. The prior `8f93e0c9b6edc083093c74cc8e6243259683d50b` JC-223 dependency-graph / governance-freeze merge remains historical provenance. JC-219, JC-220, JC-221, JC-222, and JC-223 are repository-canonical. The accepted development base remains `575ffa1848ac69abe855bd018c7ae8eaf05d61e4`.
...
- `origin/hardening/subscriptions` = `317d3c1e4304f671162b53f9d31a060682849e9e` (verified PR #27 authority-reconciliation merge; not the accepted development base)
