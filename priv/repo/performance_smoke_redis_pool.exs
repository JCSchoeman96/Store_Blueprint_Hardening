defmodule Store.PerformanceSmoke.RedisPool do
  ...
  @doc """
  Transfer RedisPool lifetime from the caller (typically setup_all) to an ExUnit
  on_exit teardown contract. The pool must remain usable through cleanup, then stop.
  """
